  ...
  async ({ event, step }) => {
    ...
    await step.run("send-connection-request-mail", async () => {
      ...
      const body = `
            ...
            <p>Click <a href="${process.env.FRONTEND_URL}/connections" style="color: #1bb981;">here</a> to accept or reject the request</p>
            <br/>
    ...
    const in12Hours = new Date(Date.now() + 24 * 60 * 60 * 1000);
    await step.sleepUntil("wait-for-24-hours", in12Hours);
