                ...
                <div className=" flex-1">
                  ...
                  <div className=" flex  max-sm:flex-col gap-2 mt-4">
                    ...
                    {currentTab === "Following" && (
                      <button onClick={() => handleUnfollow(user._id)} className="w-full p-2 text-sm rounded active:scale-95 transition text-black cursor-pointer bg-slate-100 hover:bg-slate-200  ">
                        Unfollow
                      </button>
                    )}
                    {currentTab === "Pending" && (
                      <button onClick={() => acceptConnections(user._id)} className="w-full p-2 text-sm rounded active:scale-95 transition text-black cursor-pointer bg-slate-100 hover:bg-slate-200  ">
                        Accept
                      </button>
                    )}
                    {currentTab === "Connections" && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded active:scale-95 transition text-slate-800 flex items-center justify-center gap-1 cursor-pointer bg-slate-100 hover:bg-slate-200  "
                      >
