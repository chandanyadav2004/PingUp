...
const CreatePost = () => {
  ...
  const handleSubmit = async () => {
    if(!images.length && !content){
      return toast.error("Pleases add at least one image or text")
    }
  ...
  return (
    <div className=" min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className=" max-w-6xl mx-auto p-6">
        ...
        {/* Form */}
        <div className=" max-w-xl bg-white p-4 sm:p-8 rounded-xl shadow-md scroll-py-4">
          {/* Header */}
          ...
          images.length > 0 && <div  className=" flex flex-wrap gap-2 mt-4">
            {
              images.map((image,i) => (
                <div key={i} className=" relative group">
                  ...
                  <img src={URL.createObjectURL(image)} className=" h-20 rounded-md" alt="" srcset="" />
        ...
        {/* Bottom Bar */}
          ...
          <div className=" flex items-center justify-between pt-3 border-t border-gray-300">
            ...
            })} className="  text-sm rounded-md  bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white font-medium px-8 py-2 cursor-pointer">
              Publish Post
            </button>
          </div>
